...
def convert_train_data(file_dir):
    ...
    root_dir = '/opt/mnt/yl/DIP/dataset/GTSRB1/train'
...
def convert_test_data(file_dir):
    ...
    root_dir = '/opt/mnt/yl/DIP/dataset/GTSRB1/test'
...
if __name__ == "__main__":
    train_data_dir = '/opt/mnt/yl/DIP/dataset/GTSRB/Training'
    test_data_dir = '/opt/mnt/yl/DIP/dataset/GTSRB/Final_Test/Images'
