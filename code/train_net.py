...
output_file_path = r'/opt/mnt/yl/DIP/project/output/net_data_rotate_48.txt'
with open(output_file_path,'a+') as f:
    f.writelines('epoch,test_loss,test_acc \n')

change = 'USE Data Jitter Saturation ...'
...
def validation():
    ...
    with open(output_file_path,'a+') as f:
        f.writelines('{},{},{} \n'.format(epoch,validation_loss,100. * correct / len(val_loader.dataset)))
